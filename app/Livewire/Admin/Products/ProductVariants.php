...
class ProductVariants extends Component
{
    ...
    public function save()
    {
        ...
        $this->validate([
            ...
            'variant.option_id.required' => 'El campo de opción es obligatorio.',
            'variant.features.*.id.required' => 'El campo de característica ID es obligatorio para cada característica.',
            'variant.features.*.value.required' => 'El campo de valor es obligatorio para cada característica.',
            'variant.features.*.description.required' => 'El campo de descripción es obligatorio para cada característica.',
        ]);
