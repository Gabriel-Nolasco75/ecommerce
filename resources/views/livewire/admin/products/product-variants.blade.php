<div>
    <section class="card border border-gray-100">
        ...
        <div class="p-6">
                                        ...
                                        @switch($option->type)
                                            @case(1)
                                                ...
                                                <span class="bg-gray-100 text-gray-800 text-xs font-medium me-2 pl-2.5 pr-1.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 border border-gray-500">
                                                    ...
                                                    <button onclick="confirmDeleteFeature({{$option->id}},{{$feature['id']}})" class="bg-gray-700 rounded-sm">
            ...
            @else
                ...
                <div class="flex items-center p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                    ...
                    <div>
                    <span class="font-medium">Informacion!</span> No hay opciones para este producto.
                    </div>
                </div>
    ...
    @if ($product->variants->count())
        ...
        <section class="card border border-gray-100 mt-5">
                ...
                <ul class="divide-y -my-4">
                    ...
                    @foreach ($product->variants as $item)
                        ...
                        <li class="py-4 flex items-center">
                            <img src="{{$item->image}}" alt="variantes" class="w-12 h-12 object-cover object-center">

                            <p class="divide-x text-gray-300">
            ...
            <ul class="mb-4 space-y-4">
                ...
                @foreach ($variant['features'] as $index => $feature)
                    ...
                    <li wire:key="variant-feature-{{$index}}"
                        ...
                        <div class="absolute -top-3 bg-gray-800 px-4">
