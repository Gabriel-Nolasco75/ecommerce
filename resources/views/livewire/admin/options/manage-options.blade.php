            ...
            <div class="space-y-6">
                ...
                @foreach ($options as $option)
                    ...
                    <div class="p-6 rounded-lg border border-gray-200 relative"
                        ...
                        <div class="absolute -top-3 px-4 bg-gray-600 text-gray-300">
                    ...
                    <div class="p-6 rounded-lg border border-gray-200 relative"
                        ...
                        <div class="absolute -top-3 px-4 bg-gray-800">
                            <button wire:click="removeFeature({{$index}})">
                                <i class="fa-solid fa-circle-xmark text-red-500 hover:text-red-600"></i>
                            </button>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-input 
                                    ...
                                    class="w-full"
                                    placeholder="Ingrese una desripción" />
                            </div>
